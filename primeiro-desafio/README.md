Uma API REST é uma interface de comunicação entre programas que utiliza um conjunto de regras próprias. Essas regras são definidas pelo padrão de arquitetura REST. 
